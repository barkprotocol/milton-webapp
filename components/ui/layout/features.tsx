...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description, isSelected, onClick }) => (
  <Card 
  ...
  >
    <CardHeader>
      <div className="flex items-center space-x-2">
        {icon}
        <CardTitle className="text-lg font-semibold text-primary line-clamp-2">{title}</CardTitle>
      </div>
    </CardHeader>
    <CardContent>
...
export function Features() {
  ...
  return (
    <section id="features" className="py-24 bg-gradient-to-b from-gray-100 to-gray-100 w-full overflow-hidden">
            ...
            >
              <Card className="bg-white shadow-lg border-primary/10">
                <CardHeader className="bg-primary/5">
                  <CardTitle className="text-xl sm:text-2xl font-bold text-primary">{features[selectedFeature].title}</CardTitle>
                </CardHeader>
                <CardContent className="pt-6">
                  <p className="text-gray-700 mb-4 text-base sm:text-lg">{features[selectedFeature].details}</p>
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-primary">Use Case:</h3>
                  <p className="text-gray-700 mb-6 text-base sm:text-lg">{features[selectedFeature].useCase}</p>
