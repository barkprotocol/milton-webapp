  ...
  return (
    <section className="py-8 md:py-16 bg-gradient-to-b from-gray-900 to-gray-950">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-50">Experience Blinkboard</h2>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Explore the simplicity and power of creating Blinks for various purposes.</p>
        </motion.div>
