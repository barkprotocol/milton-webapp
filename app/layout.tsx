...
export const metadata: Metadata = {
  ...
  keywords: ['DeFi', 'Blockchain', 'Solana', 'Meme Coin', 'Decentralized Finance', 'Milton'],
  ...
  openGraph: {
    ...
    description: 'Empowering users with cutting-edge blockchain technology and innovative DeFi solutions.',
    images: [
      {
